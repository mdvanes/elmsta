...
var _mdvanes$elmsta$Components_Foo$myAdder = F2(
	function (x, y) {
		return x + y;
	});
...
var _mdvanes$elmsta$Main$viewValidation = function (model) {
	var _p0 = A2(
		_elm_lang$core$Regex$contains,
		_elm_lang$core$Regex$regex('[=!-]'),
		model.password) ? {ctor: '_Tuple3', _0: 'red', _1: 'Passwords must contain not contain: =, !, -', _2: _rundis$elm_bootstrap$Bootstrap_Alert$danger} : ((_elm_lang$core$Native_Utils.cmp(
		_elm_lang$core$String$length(model.password),
		8) < 1) ? {ctor: '_Tuple3', _0: 'red', _1: 'Passwords must be longer than 8 chars', _2: _rundis$elm_bootstrap$Bootstrap_Alert$danger} : ((!_elm_lang$core$Native_Utils.eq(model.password, model.passwordAgain)) ? {ctor: '_Tuple3', _0: 'red', _1: 'Passwords do not match!', _2: _rundis$elm_bootstrap$Bootstrap_Alert$danger} : {ctor: '_Tuple3', _0: 'green', _1: 'OK', _2: _rundis$elm_bootstrap$Bootstrap_Alert$success}));
	var color = _p0._0;
	var message = _p0._1;
	var alerttype = _p0._2;
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
...
var _mdvanes$elmsta$Main$viewTermResultList = function (model) {
	var items = A2(
		_elm_lang$core$List$map,
		function (l) {
			return A2(
	...
	return A2(
		_elm_lang$html$Html$ul,
		{
			...
			_0: _elm_lang$html$Html_Attributes$style(
				{
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: 'color', _1: '#887c7c'},
					_1: {
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: 'font-family', _1: 'sans-serif'},
						_1: {ctor: '[]'}
...
var _mdvanes$elmsta$Main$viewPanel = function (msg) {
	return A2(
			...
			_0: _elm_lang$html$Html_Attributes$style(
				{
					...
					_1: {
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: 'background-color', _1: 'aliceblue'},
						_1: {
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: 'margin', _1: '1rem'},
							_1: {
								ctor: '::',
...
var _mdvanes$elmsta$Main$viewGithubBanner = A2(
	_elm_lang$html$Html$a,
	{
		ctor: '::',
		_0: _elm_lang$html$Html_Attributes$href('https://github.com/mdvanes/elmsta'),
		_1: {ctor: '[]'}
	},
	{
		ctor: '::',
...
var _mdvanes$elmsta$Main$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$none;
};
var _mdvanes$elmsta$Main$decodeWikipediaResults = A2(
...
var _mdvanes$elmsta$Main$decodeGifUrl = A2(
	_elm_lang$core$Json_Decode$at,
	{
		ctor: '::',
		_0: 'data',
...
var _mdvanes$elmsta$Main$ChangeTermInput = function (a) {
	return {ctor: 'ChangeTermInput', _0: a};
};
var _mdvanes$elmsta$Main$NewSearchResult = function (a) {
	return {ctor: 'NewSearchResult', _0: a};
};
var _mdvanes$elmsta$Main$getSearchResult = function (term) {
	var url = A2(_elm_lang$core$Basics_ops['++'], 'https://cors-anywhere.herokuapp.com/en.wikipedia.org:443/w/api.php?action=query&format=json&list=search&srsearch=', term);
	var request = A2(_elm_lang$http$Http$get, url, _mdvanes$elmsta$Main$decodeWikipediaResults);
	return A2(_elm_lang$http$Http$send, _mdvanes$elmsta$Main$NewSearchResult, request);
};
var _mdvanes$elmsta$Main$SearchImages = {ctor: 'SearchImages'};
var _mdvanes$elmsta$Main$NewFace = function (a) {
	return {ctor: 'NewFace', _0: a};
};
var _mdvanes$elmsta$Main$update = F2(
	function (msg, model) {
		var _p1 = msg;
		switch (_p1.ctor) {
			case 'Change':
			...
			case 'SearchImages':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: _mdvanes$elmsta$Main$getSearchResult(model.termInput)
				};
			case 'NewSearchResult':
				if (_p1._0.ctor === 'Ok') {
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{termResult: _p1._0._0}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
...
var _mdvanes$elmsta$Main$Roll = {ctor: 'Roll'};
var _mdvanes$elmsta$Main$PasswordAgain = function (a) {
	return {ctor: 'PasswordAgain', _0: a};
};
var _mdvanes$elmsta$Main$Password = function (a) {
	return {ctor: 'Password', _0: a};
};
var _mdvanes$elmsta$Main$Name = function (a) {
	return {ctor: 'Name', _0: a};
};
var _mdvanes$elmsta$Main$Change = function (a) {
	return {ctor: 'Change', _0: a};
};
var _mdvanes$elmsta$Main$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			ctor: '::',
			_0: _mdvanes$elmsta$Main$viewGithubBanner,
			_1: {
				ctor: '::',
				_0: A2(
							...
							_0: A2(
								...
								{ctor: '[]'},
								{
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text('Elm Test Page'),
											_1: {ctor: '[]'}
										}),
									_1: {
										ctor: '::',
										_0: _mdvanes$elmsta$Main$viewPanel(
											{
												ctor: '::',
												_0: A2(
													_rundis$elm_bootstrap$Bootstrap_Grid$row,
											...
											_0: _mdvanes$elmsta$Main$viewPanel(
												{
																						...
																						_0: _rundis$elm_bootstrap$Bootstrap_Form_Input$text(
																							{
																								...
																								_0: _rundis$elm_bootstrap$Bootstrap_Form_Input$attrs(
																									{
																										ctor: '::',
																										_0: _elm_lang$html$Html_Attributes$placeholder('Type your name here'),
																										_1: {
																											ctor: '::',
																											_0: _elm_lang$html$Html_Events$onInput(_mdvanes$elmsta$Main$Name),
																											_1: {ctor: '[]'}
																										}
																									}),
																								_1: {ctor: '[]'}
																									...
																									_0: _rundis$elm_bootstrap$Bootstrap_Form_Input$attrs(
																										{
																											...
																											_1: {
																												ctor: '::',
																												_0: _elm_lang$html$Html_Events$onInput(_mdvanes$elmsta$Main$Password),
																												_1: {ctor: '[]'}
																											}
																										}),
																									_1: {ctor: '[]'}
																					...
																					_0: A2(
																						...
																						{ctor: '[]'},
																						{
																							...
																							_0: A2(
																								...
																								{
																									ctor: '::',
																									_0: _elm_lang$html$Html$text('Re-enter Password'),
																									_1: {ctor: '[]'}
																								}),
																							_1: {
																								ctor: '::',
																										...
																										_0: _rundis$elm_bootstrap$Bootstrap_Form_Input$attrs(
																											{
																												...
																												_1: {
																													ctor: '::',
																													_0: _elm_lang$html$Html_Events$onInput(_mdvanes$elmsta$Main$PasswordAgain),
																													_1: {ctor: '[]'}
																												}
																											}),
																										_1: {ctor: '[]'}
													...
													_1: {
														ctor: '::',
														_0: _mdvanes$elmsta$Main$viewValidation(model),
														_1: {ctor: '[]'}
													}
												}),
											_1: {
												...
												_0: _mdvanes$elmsta$Main$viewPanel(
													{
														...
														_0: A2(
															...
															{
																ctor: '::',
																_0: _elm_lang$html$Html_Events$onClick(_mdvanes$elmsta$Main$Roll),
																_1: {ctor: '[]'}
															},
															{
																ctor: '::',
													...
													_0: _mdvanes$elmsta$Main$viewPanel(
														{
															...
															_0: A2(
																...
																},
																{
																	ctor: '::',
																	_0: _elm_lang$html$Html$text(
																		A2(_elm_lang$core$String$append, 'Searching ', model.termInput)),
																	_1: {ctor: '[]'}
																}),
															_1: {
																ctor: '::',
																_0: A2(
																	...
																	{
																		ctor: '::',
																		_0: _elm_lang$html$Html_Attributes$placeholder('Elmsta search term'),
																		_1: {
																			ctor: '::',
																			_0: _elm_lang$html$Html_Events$onInput(_mdvanes$elmsta$Main$ChangeTermInput),
																			_1: {
																				ctor: '::',
																				_0: _elm_lang$html$Html_Attributes$value(model.termInput),
																				_1: {ctor: '[]'}
																			}
																		}
																	},
																...
																_1: {
																	...
																	_1: {
																		ctor: '::',
																		_0: _mdvanes$elmsta$Main$viewTermResultList(model),
																		_1: {
																			ctor: '::',
																			_0: A2(
																				_elm_lang$html$Html$br,
																			...
																			_1: {
																				...
																				_0: A2(
																					...
																					{
																						ctor: '::',
																						_0: _elm_lang$html$Html_Events$onClick(_mdvanes$elmsta$Main$SearchImages),
																						_1: {ctor: '[]'}
																					},
																					{
																						ctor: '::',
																						_0: _elm_lang$html$Html$text('Search Wiki'),
																						_1: {ctor: '[]'}
																					}),
																				_1: {ctor: '[]'}
																			}
...
var _mdvanes$elmsta$Main$main = _elm_lang$html$Html$program(
	{init: _mdvanes$elmsta$Main$init, view: _mdvanes$elmsta$Main$view, update: _mdvanes$elmsta$Main$update, subscriptions: _mdvanes$elmsta$Main$subscriptions})();

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _mdvanes$elmsta$Main$main !== 'undefined') {
    _mdvanes$elmsta$Main$main(Elm['Main'], 'Main', undefined);
}
